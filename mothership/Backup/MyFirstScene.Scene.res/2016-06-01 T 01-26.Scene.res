<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2751707952">
        <_items dataType="Array" type="Duality.Component[]" id="2629819068">
          ...
          <item dataType="Struct" type="naves.Player" id="2094675956">
            ...
            <active dataType="Bool">true</active>
            <camera dataType="Struct" type="Duality.GameObject" id="3169575645">
              <active dataType="Bool">true</active>
              <children />
              <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="4160274017">
                <_items dataType="Array" type="Duality.Component[]" id="219701614" length="4">
                  ...
                  <item dataType="Struct" type="Duality.Components.Camera" id="3706851452">
                    ...
                    <passes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Camera+Pass]]" id="1304356904">
                      <_items dataType="Array" type="Duality.Components.Camera+Pass[]" id="501476780" length="4">
                        <item dataType="Struct" type="Duality.Components.Camera+Pass" id="2347875556">
                        ...
                        <item dataType="Struct" type="Duality.Components.Camera+Pass" id="3333205526">
                          <clearColor dataType="Struct" type="Duality.Drawing.ColorRgba">
                            <A dataType="Byte">0</A>
                            <B dataType="Byte">0</B>
                            <G dataType="Byte">0</G>
              ...
              <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2333562912" surrogate="true">
                <header />
                <body>
                  <keys dataType="Array" type="System.Object[]" id="519399403">
                    <item dataType="ObjectRef">1193717676</item>
                    <item dataType="Type" id="1387521654" value="Duality.Components.Camera" />
                    <item dataType="Type" id="6359322" value="Duality.Components.SoundListener" />
                  </keys>
                  <values dataType="Array" type="System.Object[]" id="3182464200">
              ...
              <identifier dataType="Struct" type="System.Guid" surrogate="true">
                <header>
                  <data dataType="Array" type="System.Byte[]" id="14409441">Yav/XxRHB0mYtaQ+emIAuw==</data>
                </header>
                <body />
              </identifier>
    ...
    <item dataType="Struct" type="Duality.GameObject" id="914845840">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1941859254">
        <_items dataType="Array" type="Duality.Component[]" id="1747969376" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="3275160772">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">914845840</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="Duality.Vector3">
              <X dataType="Float">0</X>
          ...
          <item dataType="Struct" type="Duality.Components.Camera" id="1452121647">
            <active dataType="Bool">true</active>
            <farZ dataType="Float">10000</farZ>
            <focusDist dataType="Float">500</focusDist>
            <gameobj dataType="ObjectRef">914845840</gameobj>
            <nearZ dataType="Float">0</nearZ>
            <passes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Camera+Pass]]" id="2061393515">
              <_items dataType="Array" type="Duality.Components.Camera+Pass[]" id="1289379446" length="4">
                <item dataType="Struct" type="Duality.Components.Camera+Pass" id="257751008">
                  <clearColor dataType="Struct" type="Duality.Drawing.ColorRgba">
                    <A dataType="Byte">0</A>
                    <B dataType="Byte">0</B>
                    <G dataType="Byte">0</G>
                ...
                <item dataType="Struct" type="Duality.Components.Camera+Pass" id="1095340942">
                  <clearColor dataType="Struct" type="Duality.Drawing.ColorRgba">
                    <A dataType="Byte">0</A>
                    <B dataType="Byte">0</B>
                    <G dataType="Byte">0</G>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1943407770" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="810787972">
            <item dataType="ObjectRef">1193717676</item>
            <item dataType="ObjectRef">1387521654</item>
          </keys>
          <values dataType="Array" type="System.Object[]" id="3617099926">
            <item dataType="ObjectRef">3275160772</item>
            <item dataType="ObjectRef">1452121647</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">3275160772</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="2708770880">8Doss6twxUq71PUEpoLepQ==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
